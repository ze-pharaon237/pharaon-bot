...
const waifu = db_1.default.waifu;
            ...
            try {
                ...
                if (!args[0]) {
                    ...
                    if (list_category.includes(args[0])) {
                        ...
                        let category = args[0];
                        client.sendMessage(BotsApp.chatId, (0, string_format_1.default)(waifu.NOT_FOUND_CATEGORY, category), message_type_1.MessageType.text).catch(err => input_sanitization_1.default.handleError(err, client, BotsApp));
                        return;
                    }
                }
                else {
                    client.sendMessage(BotsApp.chatId, waifu.EXTENDED_DESCRIPTION, message_type_1.MessageType.text).catch(err => input_sanitization_1.default.handleError(err, client, BotsApp));
                    return;
                }
            }
            catch (err) {
